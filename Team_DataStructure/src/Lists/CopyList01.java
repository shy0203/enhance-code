...
public class CopyList01<E> extends AbstractSequentialList<E> implements
	...
	public CopyList01(Collection<? extends E> c) {
		this();
		addAll(c);
		// Change!!
	...
	private class ListItr implements ListIterator<E> {
		...
		public void remove() {
			...
			try {
				CopyList01.this.remove(lastReturned);
	...
	public Object clone() {
		CopyList01<E> clone = null;
		try {
			clone = (CopyList01<E>) super.clone();
	...
	public void printManual() {
		System.out.println(" : Vector 참고 및 배열 추가");
	}
